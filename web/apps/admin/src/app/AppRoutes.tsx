...
const ComponentTypesPage = lazy(() =>
  import("../pages/admin/ComponentTypesPage").then((m) => ({ default: m.ComponentTypesPage }))
);
const PartNumbersPage = lazy(() =>
  import("../pages/admin/PartNumbersPage").then((m) => ({ default: m.PartNumbersPage }))
);
const MasterRoutingStepsPage = lazy(() =>
  import("../pages/admin/MasterRoutingStepsPage").then((m) => ({ default: m.MasterRoutingStepsPage }))
);
...
const CostCentersPage = lazy(() =>
  import("../pages/admin/CostCentersPage").then((m) => ({ default: m.CostCentersPage }))
);
...
const InboundPacksPage = lazy(() =>
  import("../pages/admin/InboundPacksPage").then((m) => ({ default: m.InboundPacksPage }))
);
const InventoryDoPage = lazy(() =>
  import("../pages/admin/InventoryDoPage").then((m) => ({ default: m.InventoryDoPage }))
);
const ForkliftIntakePage = lazy(() =>
  import("../pages/admin/ForkliftIntakePage").then((m) => ({ default: m.ForkliftIntakePage }))
);
const ScanSessionPage = lazy(() =>
  import("../pages/admin/ScanSessionPage").then((m) => ({ default: m.ScanSessionPage }))
);
const VendorPackDetailPage = lazy(() =>
  import("../pages/admin/VendorPackDetailPage").then((m) => ({ default: m.VendorPackDetailPage }))
);
const MaterialRequestsPage = lazy(() => import("../pages/admin/MaterialRequestsPage"));
const MaterialRequestCreatePage = lazy(() =>
  import("../pages/admin/MaterialRequestCreatePage").then((m) => ({ default: m.MaterialRequestCreatePage }))
);
const MaterialRequestDetailsPage = lazy(() =>
  import("../pages/admin/MaterialRequestDetailsPage").then((m) => ({ default: m.MaterialRequestDetailsPage }))
);
const SetRecoveryPage = lazy(() =>
  import("../pages/admin/SetRecoveryPage").then((m) => ({ default: m.SetRecoveryPage }))
);
...
const DeviceRegisterPage = lazy(() =>
  import("../pages/station/DeviceRegisterPage").then((m) => ({ default: m.DeviceRegisterPage }))
);
const JiggingStationPage = lazy(() =>
  import("../pages/station/JiggingStationPage").then((m) => ({ default: m.JiggingStationPage }))
);
const OperatorLoginPage = lazy(() =>
  import("../pages/station/OperatorLoginPage").then((m) => ({ default: m.OperatorLoginPage }))
);
const BondingStationPage = lazy(() =>
  import("../pages/station/BondingStationPage").then((m) => ({ default: m.BondingStationPage }))
);
...
const ScanStationPage = lazy(() =>
  import("../pages/station/ScanStationPage").then((m) => ({ default: m.ScanStationPage }))
);
const LabelStationPage = lazy(() =>
  import("../pages/station/LabelStationPage").then((m) => ({ default: m.LabelStationPage }))
);
const PackingStationPage = lazy(() =>
  import("../pages/station/PackingStationPage").then((m) => ({ default: m.PackingStationPage }))
);
const StationHistoryPage = lazy(() =>
  import("../pages/station/StationHistoryPage").then((m) => ({ default: m.StationHistoryPage }))
);
const FgStationPage = lazy(() => import("../pages/station/FgStationPage").then((m) => ({ default: m.FgStationPage })));
const QueueMonitorPage = lazy(() =>
  import("../pages/station/QueueMonitorPage").then((m) => ({ default: m.QueueMonitorPage }))
);
